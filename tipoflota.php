<?php
 ...
 if (isset($_REQUEST['btn_registrar'])) {
    ...
    $tipo_flota = $_POST['_nomtipoflota'];  //nombre del input text

    //ejecutamos nuestra consulta }
    $sql = "SELECT idtipo_flota, nomtipo_flota FROM tipo_flota where nomtipo_flota = '$tipo_flota'";
    ...
    if ($filas > 0) {
        ...
        $sql = "INSERT INTO tipo_flota (nomtipo_flota) VALUES ('$tipo_flota')"; 
...
if (isset($_REQUEST['btn_editar'])) {
    ...
    $id_flota = $_POST['_idflota'];
    $nom_tipoflota = $_POST['_nomtipoflota'];
    
    $sql = "UPDATE tipo_flota SET nomtipo_flota = '$nom_tipoflota' where idtipo_flota = '$id_flota'";
...
if (isset($_REQUEST['btn_eliminar'])) {
    ...
    $sql = "DELETE from tipo_flota where idtipo_flota = '$id'";
    $ejecutar = $conex ->query($sql);
...
<section class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Mantenimiento / Tipo Flota</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">Inicio</a></li>
                        <li class="breadcrumb-item active">Mantenimiento / Tipo Flota</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    ...
    <div class="content pb-2">
        ...
        <div class="row p-0 m-0">
            ...
            <div class="col-md-8">
                <div class="card card-info card-outline shadow">
                    <div class="card-header">
                        <h3 class="card-title"><i class="fas fa-list"></i>&nbspListado de tipo de flotas</h3>
                    </div>
                    <div class="card-body">
                        <table id="listatipoflota" class="table table-hover table-sm table-striped shadow rounded">
                            ...
                            ?>
                                <!--mostramos los datos-->
                                <tr>
                                    <td> <?php echo $fila['idtipo_flota'];?> </td>
                                    ...
                                    <td style="text-align: center">
                                        <div class="social-links">
                                            <a href="#" title="editar" data-bs-toggle="modal"
                                                data-bs-target="#edit_tipoflota<?php echo $fila['idtipo_flota'];?>"><i
                                ...
                                <div class="modal fade" id="edit_tipoflota<?php echo $fila['idtipo_flota'];?>"
                                    tabindex="-1" aria-labelledby="exampleModalLabel">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <!--modal cabecera-->
                                            <div class="modal-header bg-primary text-white">
                                                <h1 class="modal-title fs-5" id="exampleModalLabel" style="font-weight:bold;">Editar tipo de Flota</h1>
                                                <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                    aria-label="Close"></button>
                                            </div>
                                            <!--final modal cabecera-->

                                            <form action="tipoflota.php" method="post">
                                                <!--modal body-->
                                                <div class="modal-body">
                                                    <div class="mb-3">
                                                        <label class="form-label">N°:</label>
                                                        <input type="text" readonly class="form-control" style="width: 80px;"
                                                            name="_idflota" value="<?php echo $fila['idtipo_flota'];?>">
                                                    </div>
                                                    <div class="mb-3">
                                                        <label class="form-label">Tipo:</label>
                                                        <input type="text" class="form-control" name="_nomtipoflota"
                                                            value="<?php echo $fila['nomtipo_flota'];?>">
                                                    </div>
                                                </div>
                                                <!--final modal body-->
            ...
            <div class="col-md-4">
                <div class="card card-info card-outline shadow">
                    <div class="card-header">
                        <h3 class="card-title"><i class="fas fa-edit"></i>&nbspRegistro tipo Flota</h3>
                    </div>
                    <div class="card-body">
                        <form id="form_editarestado" action="tipoflota.php" method="post" class="needs-validation">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group mb-2">
                                        ...
                                        <!-- Caja de texto -->
                                        <input type="text" class="form-control form-control-sm" name="_nomtipoflota"
                                            placeholder="Ingrese el tipo de flota" id="estado" required>
                                        <div class="invalid-feedback">Debe ingresar tipo de flota</div>
